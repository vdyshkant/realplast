...
$(document).ready(function() {
	if($('body').is('.page-calc')){

					$('.parameters-form-minus').on('click',function(event) {
				  ...
				  $('.parameters-form-plus').on('click',function(event) {
				    event.preventDefault();
				    current = +$(this).siblings('input').val();
				    input = $(this).siblings('input');
				    $(input).val(current + 1);
...
// simple tabs for index::calculator application,
// $( document ).ready(function() {
$(window).load(function() {
